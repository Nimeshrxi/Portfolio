...
export const fallbackData: PortfolioData = {
  profile: {
    ...
    avatar: null,
    location: "India",
    email: "nimeshraivibes@gmail.com",
    phone: "6392888566",
    is_active: true,
  },
  projects: [
    {
      ...
      github_url: "https://github.com/Nimeshrxi/formula-1-simulator",
      live_url: null,
      featured_image: null,
      images: [],
      is_featured: true,
    ...
    },
    {
      ...
      github_url: "https://github.com/Nimeshrxi/ownmeet",
      live_url: null,
      featured_image: null,
      images: [],
      is_featured: true,
    ...
    },
    {
      ...
      github_url: "https://github.com/Nimeshrxi",
      live_url: null,
      featured_image: null,
      images: [],
      is_featured: true,
  ...
  experience: [
    {
      ...
      technologies: ["Python", "Django", "PostgreSQL", "REST APIs", "Tkinter", "HTML", "CSS", "Gen AI"],
      order: 1,
    },
  ],
  education: [
  ...
  social: [
    { id: 1, platform: "GitHub", url: "https://github.com/Nimeshrxi", icon: "github", order: 1, is_active: true },
    { id: 2, platform: "LinkedIn", url: "https://www.linkedin.com/in/nimesh-rai-5b5271337/", icon: "linkedin", order: 2, is_active: true },
    { id: 3, platform: "Email", url: "mailto:nimeshraivibes@gmail.com", icon: "mail", order: 3, is_active: true },
  ],
  resume: null,
  settings: {
    id: 1,
    ...
    contact_email: "nimeshraivibes@gmail.com",
    footer_text: "Built as a cinematic developer command center.",
    github_username: "nimesh-rai",
    linkedin_url: "https://www.linkedin.com/in/nimesh-rai-5b5271337/",
  },
};
